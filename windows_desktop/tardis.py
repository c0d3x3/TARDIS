...
if HAS_PYSIDE:
    class TardisMainWindow(QMainWindow):
        ...
        def init_dashboard_tab(self):
            ...
            stats_box = QGroupBox("Tdarr Status & Storage Metrics")
            sb_l = QVBoxLayout(stats_box)
            sb_l.addWidget(QLabel("Files Processed: Not available yet (connect Tdarr to measure)"))
            sb_l.addWidget(QLabel("Current Transcode Queue: Not available yet"))
            sb_l.addWidget(QLabel("Drive Space Change: Not available yet (start a session to measure)"))
            sb_l.addWidget(QLabel("Truthful Mode: Only displays real OS and API measurements"))
